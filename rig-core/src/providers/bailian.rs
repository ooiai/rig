//! Bailian (Alibaba Cloud DashScope OpenAI-Compatible) API client and Rig integration
//!
//! 默认使用 DashScope OpenAI-Compatible 模式：
...
//!
//! let client = bailian::Client::new("YOUR_BAILIAN_API_KEY");
...
const BAILIAN_API_BASE_URL: &str = "https://dashscope.aliyuncs.com/compatible-mode/v1";
...
where
    T: Default,
{
    /// Create a new Bailian client builder.
    pub fn builder(api_key: &str) -> ClientBuilder<'_, T> {
        ClientBuilder::new(api_key)
    }

    /// Create a new Bailian client. For more control, use the `builder` method.
...
impl ProviderClient for Client<reqwest::Client> {
    /// Create a new Bailian client from the `BAILIAN_API_KEY` environment variable.
    /// Optionally use `BAILIAN_BASE_URL` to override the default base URL.
    fn from_env() -> Self {
...
impl CompletionClient for Client<reqwest::Client> {
    ...
    /// # Example
    /// ```
    /// use rig::providers::bailian::Client;
    ///
    /// let bl = Client::new("your-bailian-api-key");
    /// let model = bl.completion_model("qwen-plus");
    /// ```
...
impl VerifyClient for Client<reqwest::Client> {
    ...
    async fn verify(&self) -> Result<(), VerifyError> {
        // DashScope OpenAI-Compatible may expose /models
        let req = self
            .get("/models")?
...
// ================================================================
// Bailian Chat Completions (OpenAI-compatible) API
// ================================================================
#[derive(Clone)]
...
// ================================================================
// Tool choice mapping (compatibility helper - optional)
// ================================================================
...
// ================================================================
// Bailian Embeddings (OpenAI-compatible) API
// ================================================================
